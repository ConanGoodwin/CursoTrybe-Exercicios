...
SELECT title, release_year, rental_duration FROM film WHERE rental_duration IN (3,4,5,6)
...
SELECT title, rating FROM film WHERE rating IN ('G', 'PG', 'PG-13') ORDER BY title;