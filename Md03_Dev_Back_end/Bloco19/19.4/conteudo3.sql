...
-- Corrija para $25 o valor do aluguel da tabela filmes com duração maior que 100 minutos
-- e que possuem classificação “G”, “PG” ou “PG-13” e um custo de substituição maior que $20. 
SELECT * FROM film WHERE length>100 AND rating LIKE '%G%' AND replacement_cost > 20;
UPDATE film
 SET rental_rate=25
 WHERE length>100 AND rating LIKE '%G%' AND replacement_cost > 20;
