...
#Exercicio 03
try:
    with (open("alunos.txt",mode="r") as file_in, open("alunos-reprovados.txt",mode="w") as file_out):
        reprovados = [ aluno.split(" ")[0] + "\n" for aluno in file_in if int((aluno.split(" ")[1]).replace("\n","")) < 6 ]
